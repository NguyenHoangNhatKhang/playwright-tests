...
class Calculator: 
    ...
    def __init__(self,num1,num2): #constructor
        self.num1 = num1 #instance variable, self là tham số đầu tiên của tất cả method trong class, nó đại diện cho instance hiện tại của class đó, khi gọi phương thức của class thì phải truyền self vào làm tham số đầu tiên, nếu không sẽ bị lỗi
        self.num2 = num2 
    ...
    def Summation(self):
        return self.num1 + self.num2 #method
